package com.veersaHackathon.edireader.json.driver;
...
public class EdiToJsonDriver implements Runnable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File file = new File("C:/Projects/edi-json-master/Sample824.edi");
        ...
        FileWriter myWriter = new FileWriter("NewSample.edi");
        myWriter.write(st);
        System.out.println("------------------");
        ...
        for (String arg : args) {
            ...
            if (arg.startsWith("--")) {
                ...
                if (establishedInputFile) {
                    driver.setOutputFile(new File("C:/Projects/edi-json-master/Output.json"));
                } else {
                    driver.setInputFile(file);
